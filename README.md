...
<p align="center">
  ...
  <a href="mailto:princesingh17022006@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
  <a href="https://twitter.com/prince_sin79351">
    <img src="https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white"/>
  </a>
  <img src="https://img.shields.io/badge/Open%20to%20Work-brightgreen?style=for-the-badge&logo=github&logoColor=white"/>
...
class PrinceSingh:
    def __init__(self):
        self.name        = "Prince Singh"
        self.role        = "AI Developer & ML Engineer"
        self.location    = "Varanasi, India  →  Targeting Bangalore 🚀"
        self.education   = "Mahatma Gandhi Kashi Vidyapith"
        self.email       = "princesingh17022006@gmail.com"
        self.hardware    = "NVIDIA RTX 2050 — GPU-Accelerated Builds"

    @property
    def expertise(self):
        return [
            "🤖 LLM Integration & Voice AI (Groq · Llama 3.1 · Whisper)",
            "👁️ Real-Time Computer Vision (YOLOv8/v10 · TensorRT · CUDA)",
            "✋ Gesture & Face Recognition (MediaPipe · face-api.js · SVM)",
            "⚡ End-to-End ML Pipelines (PyTorch · scikit-learn · OpenCV)",
            "🖥️  GUI & Web Dashboards  (PyQt6 · Flask · Node.js · Express)",
        ]

    def current_focus(self):
        return "Building production-ready AI systems with near-zero latency"
```
...
### ✋ [Gesture Control System](https://github.com/princesingh-ai-dev/Real-Time-Gesture-Control-System)
...
### 🔐 [Face Authentication](https://github.com/princesingh-ai-dev/Enhanced-Face-Authentication-System)
> Secure biometric auth with face-api.js + glassmorphism UI

- 🔒 Encrypted face embeddings (Fernet)
- 🌐 Browser-based & Python Flask versions
- 👤 Multi-user registration & management
- 🎨 Glassmorphism responsive UI design
...
![Llama](https://img.shields.io/badge/Llama%203.1-7B59FF?style=for-the-badge&logo=meta&logoColor=white)

</details>

<details open>
<summary><b>👁️ Computer Vision & Speech</b></summary>
<br/>

![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=for-the-badge&logo=opencv&logoColor=white)
![MediaPipe](https://img.shields.io/badge/MediaPipe-0097A7?style=for-the-badge&logo=google&logoColor=white)
![YOLOv8](https://img.shields.io/badge/YOLOv8%2Fv10-00FFFF?style=for-the-badge&logo=yolo&logoColor=black)
![Whisper](https://img.shields.io/badge/Faster%20Whisper-412991?style=for-the-badge&logo=openai&logoColor=white)
...
<p align="center">
  <i>I'm actively looking for <b>AI/ML Engineer roles in Bangalore</b> — if you're building something intelligent, let's talk!</i>
</p>
